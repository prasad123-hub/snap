        ...
        <div className="grid gap-6">
          ...
          <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Change Background
            </li>
            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Remove Snap Brading
            </li>

            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Future Updates
            </li>
            <li className="flex items-center">
